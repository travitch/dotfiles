...
DAFNY=$HOME/Tools/Dafny/4.3.0
HOMEBREW=$HOME/.homebrew/bin:/opt/homebrew/bin

export PATH=$EMACS:$HOME/.local/bin:$HOME/.ghcup/bin:$HOME/.cargo/bin:$HOMEBREW:$HOME/.cabal/bin:/usr/local/bin:/usr/bin:/bin:$HOME/Scripts:$HOME/.emacs.d/language-servers/bin:$DAFNY
